create or replace procedure add_salary_reports_monthly_sys(in_sal_date in date, proj_name_for_bonus in varchar2 DEFAULT 'nothing' ) is
...
end add_salary_reports_monthly_sys;
/
